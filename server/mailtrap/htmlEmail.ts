    ...
    <body>
      <div class="email-container">
        ...
        <div class="email-body">
          ...
          <p>We are excited to have you on board at Dine Dash. Explore our platform and enjoy our services.</p>
          <p>If you have any questions or need assistance, feel free to reach out to us.</p>
          <p>Best Regards,<br/>The Dine Dash Team</p>
        </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <p>Thank you,<br/>The Dine Dash Team</p>
          </div>
          <div class="email-footer">
            <p>&copy; 2025 DineDash. All rights reserved.</p>
          </div>
