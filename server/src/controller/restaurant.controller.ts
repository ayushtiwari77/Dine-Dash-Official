...
export const createRestaurant = async (
  ...
  try {
    ...
    const file = req.file; //is line ko run karne ke liye first import multer other wise it will not work
...
export const searchRestaurant = async (
  ...
  try {
    //url mein slash ke badd in params
    const searchText = req.params.searchText || "";

    //url mein question mark ek baad in query
